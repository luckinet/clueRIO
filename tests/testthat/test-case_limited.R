...
test_that("limited to 5 years, 2 lus, 1 increasing demand", {
#
#   # define metadata ----
#   # dir <- tempdir()
...
test_that("limited to 5 years, 3 lus, 1 increasing demand", {
#
#   # define metadata ----
#   # dir <- tempdir()
#   # dir <- "/home/se87kuhe/idiv-mount/groups/MAS/01_data/LUCKINet/allocation"
...
test_that("limited to 5 years, 3 lus, 2 stable demands", {
#
#   # define metadata ----
#   # dir <- tempdir()
#   # dir <- "/home/se87kuhe/idiv-mount/groups/MAS/01_data/LUCKINet/allocation"
