...
test_that("minimal example, 2 lus, 1 increasing demand", {
#
#   # define metadata ----
#   # dir <- tempdir()
...
test_that("minimal example, stepwise model, 2 lus, 1 increasing demand", {
#
#   # define metadata ----
#   # dir <- tempdir()
#   # dir <- "/home/se87kuhe/idiv-mount/groups/MAS/01_data/LUCKINet/allocation"
...
#
#   # start project ----
#   startProject(root = dir, name = "2lus_1demand_minimal_stepwise", start = 2000, end = 2019,
#                landuse = lus, demands = commodities)
#
#   # register gridded objects ----
#   LUS <- tibble(system = lus) %>%
...
#
#   # and finally run the model ----
#   runModel(stepwise = TRUE)
#
#   # make an animation ----
#   showAnimation(interval = 0.5)
})

test_that("minimal example, 3 lus, 1 increasing demand", {
#
#   # define metadata ----
#   # dir <- tempdir()
#   # dir <- "/home/se87kuhe/idiv-mount/groups/MAS/01_data/LUCKINet/allocation"
...
#
#   # start project ----
#   startProject(root = dir, name = "3lus_1demand_minimal", start = 2000, end = 2019,
#                landuse = lus, demands = commodities)
#
#   # register gridded objects ----
#   LUS <- tibble(system = lus) %>%
