...
test_that("'wald und feld' with a mask of possible growth", {
#
#   # define metadata ----
#   # dir <- tempdir()
...
test_that("'wald und feld' with mask of protected area", {
#
#   # define metadata ----
#   # dir <- tempdir()
#   # dir <- "/home/se87kuhe/idiv-mount/groups/MAS/01_data/LUCKINet/allocation"
...
test_that("'wald und feld' with a mask of possible growth and a protected area", {
#
#   # define metadata ----
#   # dir <- tempdir()
#   # dir <- "/home/se87kuhe/idiv-mount/groups/MAS/01_data/LUCKINet/allocation"
